...
find . -name "*.go" -type f -exec sed -i.bak \
  ...
  -e 's|"github.com/luxfi/node/consensus/engine/chain"|"github.com/luxfi/node/consensus/consensus/snowman"|g' \
  ...
  -e 's|"github.com/luxfi/node/consensus/chain/block"|"github.com/luxfi/node/consensus/engine/snowman/block"|g' \
  -e 's|"github.com/luxfi/node/consensus/chaintest"|"github.com/luxfi/node/consensus/snowtest"|g' \
