...
// Source: github.com/luxfi/evm/precompile/contract (interfaces: BlockContext,AccessibleState,StateDB)
//
...
import (
	...
	commontype "github.com/luxfi/evm/v2/v2/commontype"
	types "github.com/luxfi/evm/v2/v2/core/types"
	precompileconfig "github.com/luxfi/evm/v2/v2/precompile/precompileconfig"
...
func (m *MockAccessibleState) GetConsensusContext() *commontype.ChainContext {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetConsensusContext")
	ret0, _ := ret[0].(*commontype.ChainContext)
	return ret0
}
...
func (m *MockStateDB) GetBalanceMultiCoin(addr common.Address, coinID common.Hash) *big.Int {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBalanceMultiCoin", addr, coinID)
	ret0, _ := ret[0].(*big.Int)
	return ret0
}

// GetBalanceMultiCoin indicates an expected call of GetBalanceMultiCoin.
func (mr *MockStateDBMockRecorder) GetBalanceMultiCoin(addr, coinID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBalanceMultiCoin", reflect.TypeOf((*MockStateDB)(nil).GetBalanceMultiCoin), addr, coinID)
}
