...
// to one of the values to have an unpredicted impact in the geth consumer.
...
func TestUpstreamParamsValues(t *testing.T) {
	tests := map[string]struct {
		...
		"Bls12381G1AddGas":                  {param: ethparams.Bls12381G1AddGas, want: uint64(375)},
		"Bls12381G1MulGas":                  {param: ethparams.Bls12381G1MulGas, want: uint64(12000)},
		"Bls12381G2AddGas":                  {param: ethparams.Bls12381G2AddGas, want: uint64(600)},
		"Bls12381G2MulGas":                  {param: ethparams.Bls12381G2MulGas, want: uint64(22500)},
		"Bls12381PairingBaseGas":            {param: ethparams.Bls12381PairingBaseGas, want: uint64(37700)},
		"Bls12381PairingPerPairGas":         {param: ethparams.Bls12381PairingPerPairGas, want: uint64(32600)},
		"Bls12381MapG1Gas":                  {param: ethparams.Bls12381MapG1Gas, want: uint64(5500)},
		"Bls12381MapG2Gas":                  {param: ethparams.Bls12381MapG2Gas, want: uint64(23800)},
