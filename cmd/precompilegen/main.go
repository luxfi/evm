...
import (
	...
	"github.com/luxfi/evm/v2/v2/accounts/abi/bind/precompilebind"
	"github.com/luxfi/evm/v2/v2/internal/flags"
	"github.com/luxfi/evm/v2/v2/cmd/utils"
...
func main() {
	log.SetDefault(log.NewLogger("precompilegen"))
