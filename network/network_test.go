...
import (
	...
	"github.com/luxfi/evm/v2/v2/network/peertest"
...
var (
	...
	_ core.AppSender = testAppSender{}
...
func TestNetworkRouting(t *testing.T) {
	...
	err = network.AppRequestFailed(context.Background(), nodeID, requestID, core.ErrTimeout)
	require.ErrorIs(err, p2p.ErrUnrequestedResponse)
}
