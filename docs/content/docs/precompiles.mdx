...
contract DeployerManager {
    IDeployerAllowList constant DEPLOYER_LIST =
        IDeployerAllowList(0x0200000000000000000000000000000000000000);
...
### PQCrypto (0x0200000000000000000000000000000000000100)
...
contract QuantumSecure {
    IPQCrypto constant PQ =
        IPQCrypto(0x0200000000000000000000000000000000000100);
...
### Quasar (0x0200000000000000000000000000000000000101)
...
contract ValidatorInfo {
    IQuasar constant QUASAR =
        IQuasar(0x0200000000000000000000000000000000000101);
