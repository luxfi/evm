...
module.exports = {
  ...
  networks: {
    ...
    luxMainnet: {
      url: "https://api.lux.network/v1/bc/C/rpc",
      chainId: 96369,
      accounts: [process.env.PRIVATE_KEY],
    },
    luxTestnet: {
      url: "https://api.lux-test.network/v1/bc/C/rpc",
      chainId: 96370,
      accounts: [process.env.PRIVATE_KEY],
    },
  },
...
npx hardhat node --fork http://localhost:9650/v1/bc/C/rpc
```
...
[rpc_endpoints]
luxevm = "http://localhost:9650/v1/bc/C/rpc"
luxMainnet = "https://api.lux.network/v1/bc/C/rpc"
luxTestnet = "https://api.lux-test.network/v1/bc/C/rpc"
...
| RPC URL | https://api.lux.network/v1/bc/C/rpc | https://api.lux-test.network/v1/bc/C/rpc | http://localhost:9650/v1/bc/C/rpc |
...
const provider = new ethers.JsonRpcProvider(
  "http://localhost:9650/v1/bc/C/rpc"
);
...
// Connect to Lux EVM
const web3 = new Web3("http://localhost:9650/v1/bc/C/rpc");
...
anvil --fork-url http://localhost:9650/v1/bc/C/rpc --chain-id 43112

# With specific block
anvil --fork-url http://localhost:9650/v1/bc/C/rpc --fork-block-number 1000000
```
