...
// Connect to Lux EVM
const provider = new ethers.JsonRpcProvider("http://localhost:9650/v1/chain/C/rpc");
...
forge create src/MyContract.sol:MyContract \
  --rpc-url http://localhost:9650/v1/chain/C/rpc \
...
contract QuantumSecureVault {
    // LP-aligned address: P=2 (LP-2xxx PQ/Identity), C=2 (C-Chain), II=02 (ML-DSA)
