...
import (
	...
	statesyncclient "github.com/luxfi/evm/v2/v2/sync/client"
	"github.com/luxfi/evm/v2/v2/sync/handlers"
	handlerstats "github.com/luxfi/evm/v2/v2/sync/handlers/stats"
...
func testSync(t *testing.T, test syncTest) {
	...
	leafsRequestHandler := handlers.NewLeafsRequestHandler(serverTrieDB, common.HashLength, nil, message.Codec, handlerstats.NewNoopHandlerStats())
