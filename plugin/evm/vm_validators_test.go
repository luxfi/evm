...
import (
	...
	avagovalidators "github.com/luxfi/evm/iface"
	"github.com/luxfi/evm/iface"
...
func TestValidatorState(t *testing.T) {
	...
	err = vm.Initialize(
		context.Background(),
		utils.TestConsensusContext(), // this context does not have validators state, making VM to source it from the database
		dbManager,
		genesisBytes,
		[]byte(""),
		[]byte(""),
