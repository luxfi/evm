...
func (b *Block) Accept(context.Context) error {
	...
	rules := b.vm.chainConfig.LuxRules(b.ethBlock.Number(), b.ethBlock.Time())
...
// contract.Accepter
func (b *Block) handlePrecompileAccept(rules params.Rules, sharedMemoryWriter precompileconfig.WarpMessageWriter) error {
	...
	receipts := rawdb.ReadReceipts(b.vm.chaindb, b.ethBlock.Hash(), b.ethBlock.NumberU64(), b.ethBlock.Time(), nil)
...
func (b *Block) ShouldVerifyWithContext(context.Context) (bool, error) {
	predicates := b.vm.chainConfig.LuxRules(b.ethBlock.Number(), b.ethBlock.Time()).Predicaters
