...
curl -X POST --data '{
    ...
    "id": 1
}' -H 'content-type:application/json;' 127.0.0.1:9650/v1/chain/2ebCneCbwthjQ1rYT41nhd7M76Hc6YmosMAQrTFhBq8qeqh6tt/rpc
```
...
curl -X POST --data '{
    ...
    "params" :[]
}' -H 'content-type:application/json;' 127.0.0.1:9650/v1/chain/Nvqcm33CX2XABS62iZsAcVUkavfnzp1Sc5k413wn5Nrf7Qjt7/rpc
```
...
URL: `http://<server-uri>/v1/chain/<blockchainID>/validators`
...
curl -X POST --data '{
    ...
    "id": 1
}'  -H 'content-type:application/json;' 127.0.0.1:9650/v1/chain/C49rHzk3vLr1w9Z8sY7scrZ69TU4WcD2pRS6ZyzaSn9xA2U9F/validators
```
