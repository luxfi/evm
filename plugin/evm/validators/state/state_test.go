...
func TestState(t *testing.T) {
	...
	require.Less(timeSinceLastUpdate, time.Minute)
	...
	require.Less(timeSinceLastUpdate, time.Second)
...
func TestParseValidator(t *testing.T) {
	...
	tests := []test{
		...
		},
		{
			...
			bytes: []byte{
				// codec version (little-endian u16: 2, unknown)
				0x02, 0x00,
				// up duration (little-endian u64: 6000000)
				0x80, 0x8D, 0x5B, 0x00, 0x00, 0x00, 0x00, 0x00,
				// last updated (little-endian u64: 900000)
