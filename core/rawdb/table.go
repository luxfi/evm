...
// DeleteRange removes the keys in the range [start, end) from the database.
...
func (t *table) SyncAncient() error {
	// Since the underlying database might not support ancient operations,
	// we return nil to indicate success
	return nil
}

// SyncKeyValue flushes all in-memory data to disk.
func (t *table) SyncKeyValue() error {
	// Since the underlying database might not support this operation,
	// we return nil to indicate success
	return nil
}
