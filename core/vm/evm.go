...
import (
	...
	"github.com/luxfi/evm/v2/v2/core/headerutil"
...
type BlockContext struct {
	...
	ConsensusContext *commontype.ChainContext
...
func NewEVM(blockCtx BlockContext, txCtx TxContext, statedb StateDB, chainConfig *params.ChainConfig, config Config) *EVM {
	...
	// block context.
	predicateBytes := headerutil.PredicateBytesFromExtra(evm.chainRules, blockCtx.Extra)
...
func (evm *EVM) GetConsensusContext() *commontype.ChainContext { return evm.Context.ConsensusContext }
