...
```bash
RPC_URI=http://127.0.0.1:9650/v1/chain/28N1Tv5CZziQ3FKCaXmo8xtxoFtuoVA6NvZykAT5MtGjF4JkGs/rpc CHAIN_ID=77777 npx hardhat test --network local
```
...
```json
{
  "networks": {
    "mynetwork": {
      "url": "http://127.0.0.1:9650/v1/chain/28N1Tv5CZziQ3FKCaXmo8xtxoFtuoVA6NvZykAT5MtGjF4JkGs/rpc",
      "chainId": 33333,
      "accounts": [
...
E.g `RPC_URI=http://127.0.0.1:9650/v1/chain/28N1Tv5CZziQ3FKCaXmo8xtxoFtuoVA6NvZykAT5MtGjF4JkGs/rpc CHAIN_ID=77777 npx hardhat test --network local`.
