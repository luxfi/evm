...
// LP-aligned addresses: BASE=0x10000, address = BASE + (P << 12) | (C << 8) | II
// P=0 Core, C=2 C-Chain
const CONTRACT_ALLOW_LIST_ADDRESS = "0x0000000000000000000000000000000000010201"
const MINT_ADDRESS = "0x0000000000000000000000000000000000010204"
const TX_ALLOW_LIST_ADDRESS = "0x0000000000000000000000000000000000010203"
// P=3 EVM/Crypto, C=2 C-Chain
const FEE_MANAGER_ADDRESS = "0x000000000000000000000000000000000001320F"
const REWARD_MANAGER_ADDDRESS = "0x0000000000000000000000000000000000010205"
