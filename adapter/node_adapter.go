...
func NewBlockAdapter(block interfaces.Block) interfaces.NodeBlock {
...
func NewDatabaseAdapter(db interfaces.Database) interfaces.Database {
...
func NewValidatorStateAdapter(state interfaces.State) interfaces.ValidatorState {
...
func ChoiceAdapter(choice int) interfaces.Choice {
	switch choice {
	case 0: // Unknown
...
func NewWarpBackendAdapter(backend interfaces.Backend) interfaces.WarpBackend {
...
func (w *WarpBackendAdapter) GetMessageSignature(ctx context.Context, msg *interfaces.WarpUnsignedMessage) (*interfaces.WarpSignature, error) {
	...
	nodeMsg := &interfaces.UnsignedMessage{
